...
(cl:defmethod cl:initialize-instance :after ((m <NewGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NewGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Pick_and_Delivery-msg:<NewGoal> is deprecated: use Pick_and_Delivery-msg:NewGoal instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <NewGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Pick_and_Delivery-msg:x-val is deprecated.  Use Pick_and_Delivery-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <NewGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Pick_and_Delivery-msg:y-val is deprecated.  Use Pick_and_Delivery-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'theta-val :lambda-list '(m))
(cl:defmethod theta-val ((m <NewGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Pick_and_Delivery-msg:theta-val is deprecated.  Use Pick_and_Delivery-msg:theta instead.")
  (theta m))
