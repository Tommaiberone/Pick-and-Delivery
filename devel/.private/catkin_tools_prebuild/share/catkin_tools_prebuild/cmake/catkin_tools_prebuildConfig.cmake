...
if("TRUE" STREQUAL "TRUE")
  set(catkin_tools_prebuild_SOURCE_PREFIX /home/me/Desktop/labiagi_2020_21/workspaces/Pick-and-Delivery/build/catkin_tools_prebuild)
  set(catkin_tools_prebuild_DEVEL_PREFIX /home/me/Desktop/labiagi_2020_21/workspaces/Pick-and-Delivery/devel/.private/catkin_tools_prebuild)
  ...
  set(catkin_tools_prebuild_INSTALL_PREFIX /home/me/Desktop/labiagi_2020_21/workspaces/Pick-and-Delivery/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'catkin_tools_prebuild' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/me/Desktop/labiagi_2020_21/workspaces/Pick-and-Delivery/build/catkin_tools_prebuild/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/me/Desktop/labiagi_2020_21/workspaces/Pick-and-Delivery/devel/.private/catkin_tools_prebuild/lib;/home/me/Desktop/labiagi_2020_21/workspaces/srrg2_labiagi/devel/lib;/opt/ros/melodic/lib)
